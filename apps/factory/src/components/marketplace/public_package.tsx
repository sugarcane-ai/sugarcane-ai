...
import FilterDropdownButton, { MenuListItems } from "../filter_dropdown_button";

function PublicPackages() {
  const router = useRouter();
  const items: MenuListItems[] = [
    { text: "Newest Packages", order: filterOrder.enum.desc },
    { text: "Oldest Packages", order: filterOrder.enum.asc },
  ];

  const order: FilterOrder = router.query.order as FilterOrder;
  ...
  return (
    <>
      <div style={{ display: "flex", flexDirection: "row-reverse" }}>
        <FilterDropdownButton menuItems={items} />
      </div>
